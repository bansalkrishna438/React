...
const AnimatedComponent = () => {
  ...
  useEffect(() => {
    ...
    gsap.to(boxRef.current, { rotation: 360, y: 100,yoyo:true, duration: 0.8,repeat:-1 });
    gsap.to(boxRef1.current, { rotation: 360, y: 100,yoyo:true, duration: 0.8,repeat:-1 });
    gsap.to(boxRef2.current, { rotation: 360, y: 100,yoyo:true, duration: 0.8,repeat:-1 });
    gsap.to(boxRef3.current, { rotation: 360, y: 100,yoyo:true, duration: 0.8,repeat:-1 });
    gsap.to(boxRef4.current, { rotation: 360, y: 100,yoyo:true, duration: 0.8,repeat:-1 });
    gsap.to(boxRef5.current, { rotation: 360, y: 100, yoyo:true,duration: 0.8,repeat:-1 });
